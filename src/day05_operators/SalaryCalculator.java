...
public class SalaryCalculator {
    ...
    public static void main(String[] args) {
        ...
        double hourlyRate = 55,
                weeklyHours = 45;
        double stateTaxRate = 7;  //implicit casting; 7%
        double federalTaxRate = 24.5; //24.5%

        //------------------------------------------------------

        double salaryBeforeTax = hourlyRate * weeklyHours * 52;

        double stateTax = salaryBeforeTax * stateTaxRate / 100; //stateTax divided by 100 to get the decimal
