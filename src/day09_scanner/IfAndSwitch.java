...
public class IfAndSwitch {
 ...
 if(number == 50 ||number == 75 || number == 100){ //if the pre-condition is true we get only 3 possible outcomes.

     switch(number){ //I just use equal operator
         ...
         default:
             System.out.println("30 crew, 70 passengers"); //will be executed if the previous 2 blocks are false
             }
